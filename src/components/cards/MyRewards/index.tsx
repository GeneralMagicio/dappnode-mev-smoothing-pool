...
export function MyRewards({
  ...
  if (isLoading) {
    return (
      <BaseCard className="mx-auto h-[338px] max-w-xs sm:h-[580px]">
        <Skeleton />
      </BaseCard>
    )
  }
  ...
  return (
    <BaseCard className="mx-auto flex h-[338px] w-full max-w-md flex-col justify-between text-DAppDeep sm:h-[580px]">
